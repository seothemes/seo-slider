...
/* Object fit fallback */
jQuery(document).ready(function(c){Modernizr.objectfit||c(".slick-slide").each(function(){var i=c(this),e=i.find("img").prop("src");e&&i.css("backgroundImage","url("+e+")").addClass("no-object-fit")})});